...
const navItems = [
  { to: "/ManagerDashboard/Manager", icon: <HomeOutlined />, label: "Home" },
  { to: "/ManagerDashboard/Managment", icon: <UserAddOutlined />, label: "Register User" },
  { to: "/ManagerDashboard/Addprospect", icon: <FileAddOutlined />, label: "Add Prospect" },
  { to: "/ManagerDashboard/ReportProspect", icon: <FileTextOutlined />, label: "Prospect Report" },
  { to: "/ManagerDashboard/Sales", icon: <DollarCircleOutlined />, label: "Sales Report" },
  { to: "/ManagerDashboard/Visits", icon: <HistoryOutlined />, label: "Client Visits" }
];

const role = "Manager"; // This should be dynamically set based on the user's role

if (role !== "Manager") {
  navItems.length = 0; // Clear navItems if the role is not Manager
}
